...
with (imports) {
    task(function() {
        ...
        var optionPane = javax.swing.JOptionPane.showMessageDialog(null, 'To stop the script turn off the lumen in machine controls bottom right.');
