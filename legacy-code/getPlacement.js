...
var API_START = "https://lumen-image-storage.vercel.app/api/runs/start";
...
function uploadImageToServer(pipeline, result, folder, filename, apiUrl, runNumber) {
  ...
  function getPlacement() {
    ...
    '<cv-stage class="org.openpnp.vision.pipeline.stages.Threshold" name="highlights" enabled="true" threshold="25" auto="false" invert="false"/>' +
