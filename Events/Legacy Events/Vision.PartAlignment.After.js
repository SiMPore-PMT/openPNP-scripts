...
//     // settleTime already defined above
//     try {
//       java.lang.Thread.sleep(settleTime);
//       log("Settled for " + settleTime + " ms before capture.");
//     } catch (e) {
//       log("Sleep(" + settleTime + " ms) failed (ignored): " + e);
//     }

//     // 4) capture + run  (BufferedImage)
